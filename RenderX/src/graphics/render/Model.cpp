...
namespace renderx::graphics
{
	...
	std::vector<TextureInfo> Model::loadMaterialTextures(aiMaterial* mat, aiTextureType type, const std::string& typeName)
	{
		std::vector<TextureInfo> textures;
		for (unsigned int i = 0; i < mat->GetTextureCount(type); i++)
		{
			...
			{   // if texture hasn't been loaded already, load it
				...
				textureinfo.id = Texture::TextureFromFile(str.C_Str(), this->directory);
