...
namespace renderx::basicRenderer
{
    ...
    unsigned int BasicRenderer::cubeVAO=0;
    unsigned int BasicRenderer::cubeVBO=0;

    unsigned int BasicRenderer::quadVAO=0;
    unsigned int BasicRenderer::quadVBO=0;

    unsigned int BasicRenderer::sphereVAO=0;
    unsigned int BasicRenderer::sphereVBO=0;
    unsigned int BasicRenderer::sphereEBO=0;

    unsigned int BasicRenderer::planeVBO = 0;
    unsigned int BasicRenderer::planeVAO = 0;


    unsigned int BasicRenderer::indexCount = 0;

	void BasicRenderer::RenderCube()
	{
	...
	void BasicRenderer::RenderSphere()
	{
        if (sphereVAO == 0)
        {
